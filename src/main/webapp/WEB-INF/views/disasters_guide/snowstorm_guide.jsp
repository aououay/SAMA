    ...
    <!-- 여기에 본문 내용이 들어갑니다 -->
        ...
        <div class="content4">
            <div class="image-gallery">
                <img class="card-img" src="https://www.junggu.seoul.kr/safety/img/card/card9_1.jpg">
                <img class="card-img" src="https://www.junggu.seoul.kr/safety/img/card/card9_2.jpg">
                <img class="card-img" src="https://www.junggu.seoul.kr/safety/img/card/card9_3.jpg">
                <img class="card-img" src="https://www.junggu.seoul.kr/safety/img/card/card9_4.jpg">
            </div>
        </div>
